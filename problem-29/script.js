...
// Returning the number of possible arrangements of the board where N queens can be placed, without threatening each other
// @param {number} n
// @return {number}

function totalNQueens(n) {
    // col is what represents the columns that are taken
