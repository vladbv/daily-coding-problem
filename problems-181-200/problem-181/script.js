...
/* Returning the number of inversions in nums
 * @param {number[]} nums
 * @return {number}
 */
 ...
 */
 ...
 /* Merging process of merge sort, and returns inversions count
  * @param {number[]} nums
  * @param {number[]} aux
  * @param {number} low
  * @param {number} mid
  ...
  */
  ...
  function merge(nums, aux, low, mid, high){
    ...
    // Iterating through helper array. Compare left and right, copying back the smaller elements of both halves
    while(helperLeft <= mid && helperRight <= high) {
        ...
        helperLeft++;
          ...
          helperRight++;
          inversions += mid - helperLeft + 1; // Counting the number of inversions
      }
      current++;
    } 
