...
class URLShortener {
    ...
    // Given a shortened url, return a six-character alphanumeric string
    // @param {string} url
    // @return {string}
    ...
    // Given a shorted string, return the original url
    // @param {string} short
    // @return {string}
